...
O GitHub Pages publica apenas a landing page. Para usar envio de briefing, geração de PDF e `/admin`, rode o servidor Node localmente ou publique em uma hospedagem que execute Node.js.
